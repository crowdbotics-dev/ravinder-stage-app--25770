...
## Project Structure
    ...
    ├── ravinder_stage_app__25770  # Django project configurations
...
1. Clone this repo and `cd ravinder_stage_app__25770`
...
2. Clone this repo and `cd ravinder_stage_app__25770`
